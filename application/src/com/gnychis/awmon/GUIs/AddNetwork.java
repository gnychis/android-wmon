...
//	  netlist_80211 = (ArrayList<WifiAP>)i.get(AWMon._app_name + ".80211");
//	  netlist_ZigBee = (ArrayList<ZigBeeNetwork>)i.get(AWMon._app_name + ".ZigBee");
//	  devlist_Bluetooth = (ArrayList<BluetoothDev>)i.get(AWMon._app_name + ".Bluetooth");
...
//	
//	            if(!result._dualband)
//	            	curChildMap.put(CHAN, "Frequency: " + result._band);
//	            else
//	            	curChildMap.put(CHAN, "Frequency: " + result._band + " / " + result._band2 + " (dual-band)");
//	            
