...
abstract public class RadioScanner extends AsyncTask<InternalRadio, Integer, ArrayList<WirelessRadio> > {
	...
	public RadioScanner(WirelessRadio.Type hw_type) {
		switch(hw_type) {
			case ZigBee:
    ...
    @Override
    protected void onPostExecute(ArrayList<WirelessRadio> devices) {    		
