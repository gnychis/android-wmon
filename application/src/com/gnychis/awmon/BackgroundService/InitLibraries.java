...
public class InitLibraries extends AsyncTask<Context, Integer, String> {
	...
	protected String doInBackground( Context ... params ) {
        ...
        try {
	    	...
	    	BackgroundService.runCommand("sh /data/data/" + MainInterface._app_name + "/files/link_libraries.sh " + MainInterface._app_name);
	    	BackgroundService.runCommand("sh /data/data/" + MainInterface._app_name + "/files/link_binaries.sh " + MainInterface._app_name);
