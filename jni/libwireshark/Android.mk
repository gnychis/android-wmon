...
LOCAL_PREBUILT_LIBS := wireshark_libs/libwireshark.a wireshark_libs/libwsutil.a
...
LOCAL_LDLIBS := -L$(SYSROOT)/usr/lib -L$(LOCAL_PATH) -L$(LOCAL_PATH)/wireshark_libs -llog -lwireshark -lgcc -lwsutil -lz
