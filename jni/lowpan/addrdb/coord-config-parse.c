...
#define TOK_LEASE 259
#define TOK_HWADDR 260
#define TOK_SHORTADDR 261
#define TOK_TIMESTAMP 262
...
{
       0,     0,     3,     4,     7,    11,    14,    17,    20,    24,
      26,    28,    30,    33,    36,    39,    48,    51
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      13,     0,    -1,    -1,    14,    13,    -1,    15,    17,    16,
      -1,     4,     8,    -1,     9,    11,    -1,    18,    11,    -1,
      18,    11,    17,    -1,    19,    -1,    20,    -1,    21,    -1,
       5,    22,    -1,     6,     3,    -1,     7,     3,    -1,    23,
      23,    23,    23,    23,    23,    23,    24,    -1,    24,    10,
      -1,     3,    -1
};
...
{
       0,   130,   130,   131,   134,   137,   139,   142,   143,   146,
     147,   148,   150,   152,   154,   157,   161,   163
};
#endif
...
{
  "$end", "error", "$undefined", "TOK_NUMBER", "TOK_LEASE", "TOK_HWADDR",
  "TOK_SHORTADDR", "TOK_TIMESTAMP", "'{'", "'}'", "':'", "';'", "$accept",
  "input", "block", "lease_begin", "lease_end", "operators", "cmd",
  "cmd_hwaddr", "cmd_shortaddr", "cmd_timestamp", "hardaddr", "num_col",
  "num", 0
};
#endif
...
{
       2,     0,     0,     2,     0,     5,     1,     3,     0,     0,
       0,     0,     0,     9,    10,    11,    17,    12,     0,     0,
      13,    14,     0,     4,     7,     0,    16,     6,     8,     0,
       0,     0,     0,     0,    15
};
...
{
       0,    -3,     6,     0,    -4,   -19,   -19,   -19,     5,     7,
      12,     8,    -2,   -19,   -19,   -19,   -19,   -19,     5,     9,
     -19,   -19,    10,   -19,    -4,     5,   -19,   -19,   -19,     5,
       5,     5,     5,     5,   -19
};
...
{
      25,     8,     9,    10,     1,     5,     6,    29,    16,    24,
      20,    30,    31,    32,    33,    21,     7,    22,    28,    26,
      34,    27
};

static const yytype_uint8 yycheck[] =
{
      18,     5,     6,     7,     4,     8,     0,    25,     3,    11,
       3,    29,    30,    31,    32,     3,     3,     9,    24,    10,
      33,    11
};
...
{
       0,     4,    13,    14,    15,     8,     0,    13,     5,     6,
       7,    17,    18,    19,    20,    21,     3,    22,    23,    24,
       3,     3,     9,    16,    11,    23,    10,    11,    17,    23,
      23,    23,    23,    23,    24
};
...
/* Line 1455 of yacc.c  */
#line 146 "coord-config-parse.y"
    {do_set_hw_addr((yyvsp[(1) - (1)].hw_addr));}
    break;

  case 10:

/* Line 1455 of yacc.c  */
#line 147 "coord-config-parse.y"
    {do_set_short_addr((yyvsp[(1) - (1)].number));}
    break;

  case 11:

/* Line 1455 of yacc.c  */
#line 148 "coord-config-parse.y"
    {do_set_timestamp((yyvsp[(1) - (1)].timestamp));}
    break;

  case 12:

/* Line 1455 of yacc.c  */
#line 150 "coord-config-parse.y"
    {memcpy((yyval.hw_addr), (yyvsp[(2) - (2)].hw_addr), 8);}
    break;

  case 13:

/* Line 1455 of yacc.c  */
#line 152 "coord-config-parse.y"
...
/* Line 1455 of yacc.c  */
#line 154 "coord-config-parse.y"
    {(yyval.timestamp) = (time_t) (yyvsp[(2) - (2)].number);}
    break;

  case 15:

/* Line 1455 of yacc.c  */
#line 158 "coord-config-parse.y"
    {set_hwaddr_octets((yyval.hw_addr), (yyvsp[(1) - (8)].number), (yyvsp[(2) - (8)].number), (yyvsp[(3) - (8)].number), (yyvsp[(4) - (8)].number), (yyvsp[(5) - (8)].number), (yyvsp[(6) - (8)].number), (yyvsp[(7) - (8)].number), (yyvsp[(8) - (8)].number));}
    break;

  case 16:

/* Line 1455 of yacc.c  */
#line 161 "coord-config-parse.y"
...
/* Line 1455 of yacc.c  */
#line 1585 "coord-config-parse.c"
      default: break;
    }
